...
class UpdateBookRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'published_year' => 'sometimes|nullable|integer|min:1900|max:' . date('Y'), // Ensure the year is not in the future
    ...
    public function prepareForValidation(): void
    {
        $this->merge([
            ...
            'published_year' => $this->filled('published_year') ? (int) trim((string)$this->input('published_year')) : null,
